...
const catTraceSymbols: SymbolSeed[] = [
  ...
  { key: "mathcal_K", latex: "\\mathcal K", name: "Finite catalogue", meaning: "Finite analysis catalogue.", role: "observed data structure", layer: "observation", observedStatus: "fixed", definitionMode: "formula", definition: "K=|mathcal K|", indices: ["j"] },
  { key: "K_n", latex: "\\mathcal K_n", name: "Observed catalogue subset", meaning: "Catalogue identities detected in the first n samples.", role: "observed data subset", layer: "observation", observedStatus: "observed", definitionMode: "formula", indices: ["j"] },
  ...
  { key: "alphaK_j", latex: "\\alpha^{\\mathcal K}_j", name: "Catalogue intercept", meaning: "Finite catalogue intercept.", role: "parameter", layer: "parameterization", observedStatus: "estimated", definitionMode: "stochastic", indices: ["j"] },
  { key: "alphaU_gh", latex: "\\alpha^{\\mathcal U}_{gh}", name: "Open-tail intercept", meaning: "TRACE-calibrated group open-tail intercept.", role: "parameter", layer: "parameterization", observedStatus: "estimated", definitionMode: "stochastic", indices: ["g", "h"], definition: "alpha^U_gh | gamma_g,p_g ~ N(mu_{p_g}(gamma_g),tau_{p_g}^2)" },
  { key: "betaK_j", latex: "\\beta^{\\mathcal K}_j", name: "Catalogue slope", meaning: "Catalogue environmental response.", role: "parameter", layer: "parameterization", observedStatus: "estimated", definitionMode: "stochastic", indices: ["j"], definition: "nu+a_{g_j}+Gamma^T t_j+b^phy_j+v^K_j" },
  ...
  { key: "t_j", latex: "t_j", name: "Catalogue traits", meaning: "Catalogue trait vector when aligned.", role: "observed data", layer: "observation", observedStatus: "observed", definitionMode: "formula", indices: ["j"] },
  { key: "bphy_j", latex: "b^{\\mathrm{phy}}_j", name: "Phylogenetic random effect", meaning: "Branch-length phylogeny module effect only when real C_phy exists.", role: "parameter", layer: "parameterization", observedStatus: "estimated", definitionMode: "stochastic", indices: ["j"], constraints: ["C_tax and C_phy are distinct"] },
  { key: "vK_j", latex: "v^{\\mathcal K}_j", name: "Catalogue heterogeneity", meaning: "Catalogue species-specific response residual.", role: "parameter", layer: "parameterization", observedStatus: "estimated", definitionMode: "stochastic", indices: ["j"] },
  { key: "vU_gh", latex: "v^{\\mathcal U}_{gh}", name: "Open-tail heterogeneity", meaning: "Open-tail species-specific response residual.", role: "parameter", layer: "parameterization", observedStatus: "estimated", definitionMode: "stochastic", indices: ["g", "h"] },
  ...
  { key: "pi_g", latex: "\\pi_g", name: "Group composition weight", meaning: "Open-tail composition weight.", role: "parameter", layer: "parameterization", observedStatus: "estimated", definitionMode: "stochastic", indices: ["g"], constraints: ["sum_g pi_g = 1"] },
  { key: "gamma_g", latex: "\\gamma_g", name: "Group open-tail intensity", meaning: "Derived group intensity.", role: "derived parameter", layer: "parameterization", observedStatus: "derived", definitionMode: "deterministic", indices: ["g"], definition: "gamma_g = gamma_0*pi_g", constraints: ["No independent prior"] },
  { key: "p_g", latex: "p_g", name: "Group open-tail truncation", meaning: "Fixed computational truncation, not an estimand or true unknown species count.", role: "fixed computational setting", layer: "parameterization", observedStatus: "fixed", definitionMode: "formula", indices: ["g"], constraints: ["not estimand", "not true unknown species count"] },
  { key: "p_g_star", latex: "p_g^*", name: "Non-empty open-tail count", meaning: "Non-empty open-tail columns in the first n samples.", role: "observed count", layer: "measurement", observedStatus: "observed", definitionMode: "formula", indices: ["g"] },
  { key: "zero_slots", latex: "p_g-p_g^*", name: "Anonymous zero slots", meaning: "Zero open-tail slots retained by the likelihood.", role: "fixed zero-slot multiplicity", layer: "measurement", observedStatus: "fixed", definitionMode: "formula", indices: ["g"] },
...
const catTraceRelations: RelationSeed[] = [
  ...
  { source: "c_f", target: "mathcal_U", type: "matched_to", label: "empty/unmatched feature enters open tail" },
]
