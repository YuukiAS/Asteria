...
const originalTraceSymbols: SymbolSeed[] = [
  ...
  { key: "marginal_probability", latex: "P(y_{ij}=1\\mid x_i,\\alpha_j,\\beta_j)", name: "Marginal occurrence probability", meaning: "Unit-variance probit marginal mean.", role: "target", layer: "prediction", observedStatus: "derived", definitionMode: "deterministic", definition: "Phi(alpha_j + x_i^T beta_j)" },
...
const originalTraceRelations: RelationSeed[] = [
  { source: "z_ij", target: "y_ij", type: "depends_on", label: "thresholds into" },
  { source: "alpha_j", target: "z_ij", type: "parameterized_by", label: "intercept" },
  { source: "x_i", target: "z_ij", type: "depends_on", label: "covariate input" },
  ...
  { source: "alpha_j", target: "marginal_probability", type: "depends_on", label: "probit mean" },
  { source: "beta_j", target: "marginal_probability", type: "depends_on", label: "probit mean" },
  { source: "marginal_probability", target: "richness_target", type: "derived_from", label: "summed target" },
]
...
const catTraceSymbols: SymbolSeed[] = [
  ...
  { key: "richness_targets", latex: "R_g,R_0", name: "Richness and discovery targets", meaning: "Group/total open-tail richness plus catalogue/open-tail discovery targets.", role: "target", layer: "prediction", observedStatus: "derived", definitionMode: "formula" },
]

const catTraceRelations: RelationSeed[] = [
  { source: "c_f", target: "mathcal_K", type: "depends_on", label: "matches into" },
  { source: "g_f", target: "mathcal_G", type: "depends_on", label: "groups by" },
  { source: "zK_ij", target: "yK_ij", type: "depends_on", label: "thresholds into" },
  { source: "zU_igh", target: "yU_igh", type: "depends_on", label: "thresholds into" },
  ...
  { source: "x_i", target: "zU_igh", type: "depends_on", label: "covariate input" },
  ...
  { source: "t_j", target: "betaK_j", type: "depends_on", label: "trait input" },
  ...
  { source: "mathcal_W", target: "Sigma_W", type: "depends_on", label: "finite scope" },
  { source: "yU_igh", target: "richness_targets", type: "derived_from", label: "open-tail discovery" },
  { source: "K_n", target: "richness_targets", type: "derived_from", label: "catalogue discovery" },
]
