...
export function createCatTraceMultiViewProject() {
  ...
  const evidenceEntities: EntitySeed[] = [
    ...
    { id: "entity:evidence:implementation:fixtures", kind: "implementation", label: "Asteria schema-v2 fixtures", role: "implementation evidence", description: "Regression fixtures validate canonical symbols, semantic diff, export, and V1 migration.", observedStatus: "observed" },
