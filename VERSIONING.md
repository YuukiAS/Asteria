...
- `2.0.0-rc.9`：Human visual acceptance repair for stable Overview geometry, non-overlap card packing, compact relation-label presentation, rendered Semantic Diff math, stable-facing Lineage/Evidence copy, and direct visual regression coverage.
