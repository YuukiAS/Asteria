...
try {
  ...
  assert(packageJson.version === "2.0.0-rc.8", "package.json must declare the current RC version.")
  assert(appSource.includes('const appVersion = "2.0.0-rc.8"'), "App shell must display the current RC version.")
