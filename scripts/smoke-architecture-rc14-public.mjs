...
try {
  ...
  console.log(JSON.stringify({ status: "public-smoke-pass", publicUrl, observedVersion: "2.0.0-rc.14", architectureSafeBounds: "PASS", lineageEndpointErrorMax: lineage.endpointErrorMax }, null, 2))
} finally {
  await browser.close()
}
