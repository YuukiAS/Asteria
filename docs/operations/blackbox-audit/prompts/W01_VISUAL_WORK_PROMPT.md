# W01 — Visual / Scientific Product Design — Ready-to-Paste GPT Work Prompt
...
这是一个 statistical research IDE / model architecture atlas，不是 SaaS dashboard。请只从普通研究者真实看到的界面判断是否达到可以发布 2.0 stable 的视觉与信息设计水平。
