...
- Wrote Asteria rich copy/cut HTML explicitly so copied equations keep visible KaTeX markup and paste-back identity instead of relying on the browser's default ProseMirror DOM copy.
